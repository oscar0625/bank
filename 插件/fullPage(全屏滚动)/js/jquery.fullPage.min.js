 ...
 */
(function (c, l) {
    "function" === typeof define && define.amd ? define(["jquery.fullPage.min"], function (m) {
    ...
    c.fn.fullpage = function (d) {
        function La() {
            ...
            ka();
            n.on("load", function () {
                var a = l.location.hash.replace("#", "").split("/"), c = a[0], a = a[1];
        ...
        function A(a) {
            ...
            if (d.autoScrolling && !N) {
                a = a || l.event;
                var g = a.wheelDelta || -a.deltaY || -a.detail, f = p.max(-1, p.min(1, g)), e = "undefined" !== typeof a.wheelDeltaX || "undefined" !== typeof a.deltaX, e = p.abs(a.wheelDeltaX) < p.abs(a.wheelDelta) || p.abs(a.deltaX) < p.abs(a.deltaY) || !e;
        ...
        function ya() {
            if (!W && !d.lockAnchors) {
                var a = l.location.hash.replace("#", "").split("/"), b = a[0], a = a[1], c = "undefined" === typeof y, f = "undefined" === typeof y && "undefined" === typeof a && !w;
        ...
        function G(a, b) {
            var g = b.position(), f = b.index(), e = a.closest(".fp-section"), h = e.index(".fp-section"), k = e.data("anchor"), l = e.find(".fp-slidesNav"), m = fa(b), n = v;
            if (d.onSlideLeave) {
            ...
            d.css3 ? (g = "translate3d(-" + p.round(g.left) + "px, 0px, 0px)", za(a.find(".fp-slidesContainer"), 0 < d.scrollingSpeed).css(Aa(g)), ga = setTimeout(function () {
                u()
            }, d.scrollingSpeed, d.easing)) : a.animate({scrollLeft: p.round(g.left)},
        ...
        function ka() {
            var a = c(".fp-section.active"), b = a.find(".fp-slide.active"), d = fa(a), f = fa(b);
            a.index(".fp-section");
            a = String(d);
            b.length && (a = a + "-" + f);
            a = a.replace("/", "-").replace("#", "");
        ...
        e.setMouseWheelScrolling = function (a) {
            if (a) {
                ...
                if ("DOMMouseScroll" == c)m[b](a + "MozMousePixelScroll", A, !1); else m[b](a +
                c, A, !1)
        ...
        var w = !1, P = navigator.userAgent.match(/(iPhone|iPod|iPad|Android|playbook|silk|BlackBerry|BB10|Windows Phone|Tizen|Bada|webOS|IEMobile|Opera Mini)/), Q = "ontouchstart"in l || 0 < navigator.msMaxTouchPoints || navigator.maxTouchPoints, h = c(this), q = n.height(), v = !1, Ja = !0, y, ea, u = !0, B = [], N, k = {
            m: {
                up: !0, down: !0,
                left: !0, right: !0
            }
        ...
        k.k = c.extend(!0, {}, k.m);
        var C = c.extend(!0, {}, d), ia, ca, ga, Z, aa, Ka;
        c(this).length && La();
        var W = !1;
        n.on("scroll", pa);
